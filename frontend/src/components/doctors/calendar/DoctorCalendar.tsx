...
const DoctorCalendar: React.FC = () => {
  ...
  const handleEditedTimeSlotChange = (
    field: "start" | "end",
    value: string
  ) => {
                ...
                {Object.entries(selectedTimeSlots).map(([day, slots]) => (
                  <div key={day} className="mb-4">
                    <h3 className="font-bold">
                      {daysOfWeek.find((d) => d.day.toString() === day)?.label}
                    </h3>
                    <ul>
          ...
          <div className="mt-4 p-4 bg-gray-100 border rounded">
            ...
            <div className="mb-2">
              ...
              <input
                ...
                onChange={(e) =>
                  handleEditedTimeSlotChange("start", e.target.value)
                }
              />
            </div>
            <div className="mb-2">
              ...
              <input
                ...
                onChange={(e) =>
                  handleEditedTimeSlotChange("end", e.target.value)
                }
              />
            </div>
      ...
      <div className="mt-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          {scheduledSlots.map((slot) => (
            <div
              key={slot._id}
              className="bg-blue-100 border border-blue-300 shadow-lg rounded-lg p-6 ml-16 mb-8"
            >
