...
import { Department, DoctorSignupFormValues } from "../../interfaces/signUp";
...
const SignUp: React.FC = () => {
  ...
  const formik = useFormik<DoctorSignupFormValues>({
    initialValues: {
      name: "",
      email: "",
      phoneNumber: "",
    ...
    onSubmit: async ({
      ...
      axios
        .post(DOCTOR_API + "/signup", {
          ...
          description,
          experience,
          licenseCertificate: certificateUrl,
        })
        .then(({ data }) => {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    if (e.target.files) {
      ...
      formik.setFieldValue("licenseCertificate", file);
        ...
        <div className="bg-gray-200 w-full max-w-lg md:w-4/12 shadow-lg rounded-lg p-6 md:p-10 mt-14 mb-10">
          ...
          <form onSubmit={formik.handleSubmit}>
            ...
            <div className="mb-4">
              ...
              />
              {formik.errors.licenseCertificate &&
                formik.touched.licenseCertificate && (
                  <div className="text-red-500">
                    {formik.errors.licenseCertificate}
                  </div>
                )}
