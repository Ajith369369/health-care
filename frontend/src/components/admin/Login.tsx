  ...
  return (
    <>
      <div className="flex items-center justify-center h-screen bg-gradient-to-r from-blue-300 to-blue-500">
        <form
          className="bg-white shadow-lg rounded-lg  p-8 flex flex-col lg:flex-row items-center justify-center lg:ml-20"
          onSubmit={formik.handleSubmit}
        >
          <img
            src={AdminImage}
            alt="Admin"
            className="rounded-full w-96 mb-6 lg:mr-8"
          />
          <div className="flex flex-col w-full">
            <h2 className="text-3xl font-bold mb-6 mr-14 text-center text-blue-900 shadow-md">
              Admin Login
            </h2>
            <div className="mb-6">
              <label
                className="block text-blue-900 text-m  font-bold mb-2"
                htmlFor="email"
              >
                Email
              </label>
